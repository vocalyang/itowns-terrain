...
const colorData = ColorData.map((e) => {
    let data = e.split(' ');
    data = data.map(v => Number(v));
    return new THREE.Vector4(data[1] / 255, data[2] / 255, data[3] / 255, data[5]);
    // {
    //     height: data[0],
    //     r: data[1],
    //     g: data[2],
...
class LayeredMaterial extends THREE.RawShaderMaterial {
    ...
    constructor(options = {}, crsCount) {
        ...
        // colorData
        // this.defines.NUM_COLORDATA = colorData.length;
        // CommonMaterial.setUniformProperty(this, 'colorData', colorData);
