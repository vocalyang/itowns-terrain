...
class TiledGeometryLayer extends GeometryLayer {
    ...
    isExceedSourceZoomMax(context, node) {
        ...
        return node.level < (isExtentInElevation ? zoomMax : 17);
    }
    ...
    subdivision(context, layer, node) {
        ...
        if (nodeLayer) {
            ...
            if (currentTexture && currentTexture.extent) {
                ...
                this.maxDeltaElevationLevel = 6;
                // ratio is node size / texture size
                // if (node.level === 17) {
                //     this.maxDeltaElevationLevel = 6;
                // }
                // this.sseSubdivisionThreshold = 2;
